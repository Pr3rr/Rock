...
class Life_Settings {
    ...
    gang_price = 10000; //Price for creating a gang, remember they are persistent so keep it reasonable to avoid millions of gangs.
    ...
    paycheck_civ = 2000000; //Payment for civillians
